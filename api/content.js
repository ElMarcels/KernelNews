...
async function getAll() {
  const [n, t, e] = await Promise.all([
    pool.query(`select id, title, category, subtopic, minutes, date, excerpt, content, image, featured from noticias order by created_at desc`),
...
async function doSetup() {
  const statements = [
    ...
    `alter table noticias add column if not exists subtopic text default ''`,
  ...
  try {
    ...
    if (Array.isArray(noticias)) {
      for (const n of noticias) {
        await client.query(
          `insert into noticias (title, category, subtopic, minutes, date, excerpt, content, image, featured)
           values ($1, $2, $3, $4, $5, $6, $7, $8, $9)`,
          [n.title || "", n.category || "", n.subtopic || "", n.minutes || 1, n.date || "", n.excerpt || "", n.content || "", n.image || "", !!n.featured]
        );
      }
    }
